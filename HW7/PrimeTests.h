...
public:
	...
	bool pFarmTest(uint64_t number, uint64_t accuracy);

	bool pMillerRabinTest(uint64_t number, uint64_t accuracy);

	uint64_t gcd(uint64_t a, uint64_t b);

	uint64_t fastModulePow(uint64_t base, uint64_t degree, uint64_t mod);
};
